...
export default function Orders() {
  return (
    <div>
      ...
      <div className="max-w-screen-2xl mx-auto">
        <div className="mx-4 sm:mx-9 my-5">
          <div className="flex flex-wrap gap-4 justify-between bg-white py-2 px-4">
            <div>
              {/* <button className="rounded-md w-full sm:w-auto bg-gradient-to-tr from-gray-150 to-gray-250 text-white px-6 py-2 text-lg font-medium" onClick={e => setIsOpen(pre => !pre)}>Add Product</button> */}
            </div>
      ...
      {/* <AddOffer isOpen={isOpen} setIsOpen={setIsOpen} /> */}
    </div>
  )
}
